...
public class SemanticAnalysis implements Visitor {
  ...
  public void check(Program progAST) {
    ...
    /* Start of your code: */
    if(scopeStack.retrieve("main") == null) reporter.reportError(errMsg[0], "", new SourcePos());
    /* End of your code */
  }
  ...
  public void visit(FunDecl x) {
    ...
    /* Start of your code: */
    if(!scopeStack.enter(x.idAST.Lexeme, x)) reporter.reportError(errMsg[2], "", new SourcePos());
    /* End of your code */
    ...
    if(x.idAST.Lexeme.equals("main") && !x.tAST.Tequal(StdEnvironment.intType)){
      reporter.reportError(errMsg[1], "", new SourcePos());
    }
    /* End of your code */
  ...
  public void visit(FormalParamDecl x) {
    ...
    /* Start of your code: */
    if(!scopeStack.enter(x.astIdent.Lexeme, x)) reporter.reportError(errMsg[2], "", new SourcePos());
    /* End of your code */
    ...
    /* Start of your code: */
    if(x.astType.Tequal(StdEnvironment.voidType)) reporter.reportError(errMsg[3], "", new SourcePos());
    if(x.astType instanceof ArrayType){
      if(typeOfArrayType(x.astType).Tequal(StdEnvironment.voidType))
        reporter.reportError(errMsg[4], "", new SourcePos());
    }
    /* End of your code */
  }
  ...
  public void visit(AssignStmt x) {
    ...
    /* Start of your code: */
    if(x.rAST.type.AssignableTo(x.lAST.type)){ // int int or float int or float float
      // float int need i2f coercion
      if(x.lAST.type.Tequal(StdEnvironment.floatType) && x.rAST.type.Tequal(StdEnvironment.intType)){
        x.rAST = i2f(x.rAST);
      }
    }
    else reporter.reportError(errMsg[6], "", x.lAST.pos);
    /* End of your code */
  ...
  public void visit(IfStmt x) {
    ...
    /* Start of your code: */
    if(!x.eAST.type.Tequal(StdEnvironment.boolType)) reporter.reportError(errMsg[20], "", x.eAST.pos);
    /* End of your code */
  ...
  public void visit(WhileStmt x) {
    ...
    /* Start of your code: */
    if(!x.eAST.type.Tequal(StdEnvironment.boolType)) reporter.reportError(errMsg[22], "", x.eAST.pos);
    /* End of your code */
    x.stmtAST.accept(this);
  }
  ...
  public void visit(EmptyCompoundStmt x) {
    ...
    /* Start of your code: */
    if(IsFunctionBlock) scopeStack.closeScope();
    /* End of your code */
  }
  ...
  public void visit(VarDecl x) {
    ...
    if (!(x.eAST instanceof EmptyExpr)) {
      ...
      if (x.tAST instanceof ArrayType) {
        ...
        /* Start of your code: */
        // scalar initializer
        if(!(x.eAST instanceof ExprSequence)) reporter.reportError(errMsg[15], "", new SourcePos());
        else{ // array initializer
          ExprSequence ES = (ExprSequence)x.eAST;
          Type T = typeOfArrayType(x.tAST);
          int cnt=0;
          while(!(ES.rAST instanceof EmptyExpr)){
            cnt++;
            ES.lAST.accept(this);
            if(!ES.lAST.type.AssignableTo(T)){ // not matched type
              reporter.reportError(errMsg[13], "", new SourcePos());
            }
            // float int --> need i2f
            if(ES.lAST.type.Tequal(StdEnvironment.intType) && T.Tequal(StdEnvironment.floatType)){
              ES.lAST = i2f(ES.lAST);
            }
            ES = (ExprSequence)ES.rAST; // move next
          }
          // process last element
          cnt++;
          ES.lAST.accept(this);
          if(!ES.lAST.type.AssignableTo(T)){
            reporter.reportError(errMsg[13], "", new SourcePos());
          }
          if(ES.lAST.type.Tequal(StdEnvironment.intType) && T.Tequal(StdEnvironment.floatType)){
            ES.lAST = i2f(ES.lAST);
          ...
          IntExpr IE = (IntExpr)AT.astExpr;
          int num = Integer.parseInt(IE.astIL.Lexeme);
          if(num < cnt) reporter.reportError(errMsg[16], "", new SourcePos());
        }
        /* End of your code */
      } else {
        //STEP 4:
        ...
        /* Start of your code: */
        // array initializer
        if(x.eAST instanceof ExprSequence) reporter.reportError(errMsg[14], "", new SourcePos());
        else{
          // not matched type
          if(!x.eAST.type.AssignableTo(x.tAST)) reporter.reportError(errMsg[6], "", new SourcePos());
          // float int --> need i2f
    ...
    /* Start of your code: */
    if(x.tAST.Tequal(StdEnvironment.voidType)) reporter.reportError(errMsg[3], "", new SourcePos());
    if(x.tAST instanceof ArrayType){
      if(typeOfArrayType(x.tAST).Tequal(StdEnvironment.voidType))
        reporter.reportError(errMsg[4], "", new SourcePos());
    }
    /* End of your code */
  }
  ...
  public void visit(BinaryExpr x) {
    ...
    if(HasIntOrFloatArgs(x.oAST)) {
      if(x.lAST.type.Tequal(StdEnvironment.intType) &&
        ...
        x.rAST = i2f(x.rAST);
        x.oAST.type = StdEnvironment.floatType;
        if(HasBoolReturnType(x.oAST)) x.type = StdEnvironment.boolType;
        else x.type = StdEnvironment.floatType;
        /* End of your code */
        return;
      }
    }
  ...
  public void visit(UnaryExpr x) {
    ...
    /* Start of your code: */
    if(x.eAST.type.Tequal(StdEnvironment.intType) && !HasBoolReturnType(x.oAST)){
      x.oAST.type = x.eAST.type;
      x.type = x.eAST.type; 
    }
    else if(x.eAST.type.Tequal(StdEnvironment.floatType) && !HasBoolReturnType(x.oAST)){
      x.oAST.type = x.eAST.type;
      x.type = x.eAST.type;
    }
  ...
  public void visit(CallExpr x) {
    ...
    if(NrOfFormalParams < NrOfActualParams) reporter.reportError(errMsg[23], "", x.pos);
    else if(NrOfFormalParams > NrOfActualParams) reporter.reportError(errMsg[24], "", x.pos);
    /* End of your code */
     ...
     * Start of your code:*/
     ...
     //int NrFormalParams = GetNrOfFormalParams(F);
       ...
       for (int i = 1; i<= NrOfFormalParams; i++) {
         ...
         if(!ActualT.AssignableTo(FormalT)) reporter.reportError(errMsg[25], "", x.pos);
         // assignable + float int --> need i2f
         else{
  ...
  public void visit(ID x) {
    ...
    /* Start of your code: */
    else reporter.reportError(errMsg[5], "", x.pos);
    /* End of your code */
  }

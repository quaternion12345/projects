...
public class Emitter implements Visitor {
	...
	emit("; IfStmt, line " + x.pos.StartLine);
        ...
        emit(JVM.IFEQ + " Label" + Integer.toString(L1));
        x.thenAST.accept(this);
        //TBD: your code goes here...
        emit(JVM.GOTO + " Label" + Integer.toString(L2));
        emitLabel(L1);
        if(x.elseAST != null) {
	...
	emit("; WhileStmt, line " + x.pos.StartLine);
        ...
        // Allocate 2 new labes for this if statement.
        //TBD: your code goes here...
        emit(JVM.IFEQ + " Label" + Integer.toString(L2));
        x.stmtAST.accept(this);
        //TBD: your code goes here...
        emit(JVM.GOTO + " Label" + Integer.toString(L1));
	...
	x.eAST.accept(this);
        ...
        //                        frame.getNewLocalVarIndex
	        if(x.isGlobal())
           {
              emitStaticVariableReference(x.idAST, typeOfDecl(x.idAST.declAST), true);
           }
           else
           	{
           		x.index=frame.getNewLocalVarIndex();
	...
	emit("; BinaryExpr");
        ...
        if(Op.equals("||")) {
            ...
            //     from the lecture slides.
            x.lAST.accept(this);
            emit(JVM.IFNE + " Label" + Integer.toString(L1));
            x.rAST.accept(this);
            emit(JVM.IFNE + " Label" + Integer.toString(L1));
            emit("iconst_1");
        	emit(JVM.GOTO + " Label" + Integer.toString(L2));
        ...
        if(Op.equals(">") && x.oAST.type.Tequal(StdEnvironment.intType))
        {
            int L1 = frame.getNewLabel();
            int L2 = frame.getNewLabel();
        	emit(JVM.IF_ICMPGT + " Label" + Integer.toString(L1));
        	emit("iconst_0");
        	emit(JVM.GOTO + " Label" + Integer.toString(L2));
        	emitLabel(L1);
        	emit("iconst_1");
        ...
        if(Op.equals(">=") && x.oAST.type.Tequal(StdEnvironment.intType))
        {
            int L1 = frame.getNewLabel();
            int L2 = frame.getNewLabel();
        	emit(JVM.IF_ICMPGE + " Label" + Integer.toString(L1));
        	emit("iconst_0");
        	emit(JVM.GOTO + " Label" + Integer.toString(L2));
        	emitLabel(L1);
        	emit("iconst_1");
        ...
        if(Op.equals("<") && x.oAST.type.Tequal(StdEnvironment.intType))
        {
            int L1 = frame.getNewLabel();
            int L2 = frame.getNewLabel();
        	emit(JVM.IF_ICMPLT + " Label" + Integer.toString(L1));
        	emit("iconst_0");
        	emit(JVM.GOTO + " Label" + Integer.toString(L2));
        	emitLabel(L1);
        	emit("iconst_1");
        ...
        if(Op.equals("<=") && x.oAST.type.Tequal(StdEnvironment.intType))
        {
            int L1 = frame.getNewLabel();
            int L2 = frame.getNewLabel();
        	emit(JVM.IF_ICMPLE + " Label" + Integer.toString(L1));
        	emit("iconst_0");
        	emit(JVM.GOTO + " Label" + Integer.toString(L2));
        	emitLabel(L1);
        	emit("iconst_1");
        ...
        if(Op.equals("==") && x.oAST.type.Tequal(StdEnvironment.intType))
        {
            int L1 = frame.getNewLabel();
            int L2 = frame.getNewLabel();
        	emit(JVM.IF_ICMPEQ + " Label" + Integer.toString(L1));
        	emit("iconst_0");
        	emit(JVM.GOTO + " Label" + Integer.toString(L2));
        	emitLabel(L1);
        	emit("iconst_1");
        ...
        if(Op.equals("!=") && x.oAST.type.Tequal(StdEnvironment.intType))
        {
            int L1 = frame.getNewLabel();
            int L2 = frame.getNewLabel();
        	emit(JVM.IF_ICMPNE + " Label" + Integer.toString(L1));
        	emit("iconst_0");
        	emit(JVM.GOTO + " Label" + Integer.toString(L2));
        	emitLabel(L1);
        	emit("iconst_1");
        ...
        if(Op.equals(">"))
        {
            int L1 = frame.getNewLabel();
            int L2 = frame.getNewLabel();
        	emit(JVM.IFGT + " Label" + Integer.toString(L1));
        	emit("iconst_0");
        	emit(JVM.GOTO + " Label" + Integer.toString(L2));
        	emitLabel(L1);
        	emit("iconst_1");
        ...
        if(Op.equals(">="))
        {
            int L1 = frame.getNewLabel();
            int L2 = frame.getNewLabel();
        	emit(JVM.IFGE + " Label" + Integer.toString(L1));
        	emit("iconst_0");
        	emit(JVM.GOTO + " Label" + Integer.toString(L2));
        	emitLabel(L1);
        	emit("iconst_1");
        ...
        if(Op.equals("<"))
        {
            int L1 = frame.getNewLabel();
            int L2 = frame.getNewLabel();
        	emit(JVM.IFLT + " Label" + Integer.toString(L1));
        	emit("iconst_0");
        	emit(JVM.GOTO + " Label" + Integer.toString(L2));
        	emitLabel(L1);
        	emit("iconst_1");
        ...
        if(Op.equals("<="))
        {
            int L1 = frame.getNewLabel();
            int L2 = frame.getNewLabel();
        	emit(JVM.IFLE + " Label" + Integer.toString(L1));
        	emit("iconst_0");
        	emit(JVM.GOTO + " Label" + Integer.toString(L2));
        	emitLabel(L1);
        	emit("iconst_1");

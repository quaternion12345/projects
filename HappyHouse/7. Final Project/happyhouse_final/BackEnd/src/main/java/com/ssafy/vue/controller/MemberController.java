...
//				로그인 사용자 정보.
	...
	@ApiOperation(value = "회원 가입을 한다. 그리고 DB입력 성공여부에 따라 'success' 또는 'fail' 문자열을 반환한다.", response = String.class)
	@PostMapping("/register")
	public ResponseEntity<String> writeInterest(@RequestBody MemberDto memberDto) {
		logger.debug("writeBoard - 호출");
		if (memberService.insertUser(memberDto)) {
	...
	public ResponseEntity<String> updateInterest(@RequestBody MemberDto memberDto) {
	...
	public ResponseEntity<String> deleteInterest(@PathVariable String userid) {

            ...
            <div class="login-page">
                ...
                <div class="form">
                  <form name="register-form" class="register-form">
                    ...
                    <input id="name" name="name" type="text" value="${member.name}" readonly/>
                    ...
                    <input id="phone" name="phone" type="tel" value="${member.phone}" readonly/>                    
                    <button onclick="location.href='modifyMember.do'" type="button" style='margin-left: 60px; margin-right:5px'>정보 수정</button>
                    <button onclick="location.href='removeMember.do'" type="button">회원 탈퇴</button>

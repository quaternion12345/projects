    ...
    <body>
        ...
        <main class="container">
            <div class="login-page">
                ...
                <div class="form">
                  <form name="register-form" class="login-form" method="post" action="insertMember.do">
                    ...
                    <input type="submit" value="회원 등록" style='background: gray; color: #ffffff;'/>
                    <input type="reset" value="취소" style='background: gray; color: #ffffff;'/>
